; Script generated by the HM NIS Edit Script Wizard and modified manually for Proximodo 0.2.5.
...
LangString PROXY_TITLE    ${LANG_JAPANESE} "ГuГЙГEГUРЁТи"
...
Section -ProximodoFiles
  ...
  File "..\bin\help\bg1.jpg"
  File "..\bin\help\bg2.jpg"
  File "..\bin\help\bg3.jpg"
  File "..\bin\help\bg4.jpg"
  File "..\bin\help\bg5.jpg"
  File "..\bin\help\btn1.gif"
  File "..\bin\help\btn2.gif"
  File "..\bin\help\btn3.gif"
  File "..\bin\help\btn4.gif"
  File "..\bin\help\btn5.gif"
  File "..\bin\help\btn6.gif"
  File "..\bin\help\btn7.gif"
  File "..\bin\help\gnu.gif"
...
LangString UNINST_SUCCESS ${LANG_JAPANESE} "$(^Name)ВћГCГУГXГgБ[ГЛВ™КЃЧєВµВ№ВµВљБB"
...
Section Uninstall
  ...
  Delete "$INSTDIR\help\gnu.gif"
  Delete "$INSTDIR\help\btn7.gif"
  Delete "$INSTDIR\help\btn6.gif"
  Delete "$INSTDIR\help\btn5.gif"
  Delete "$INSTDIR\help\btn4.gif"
  Delete "$INSTDIR\help\btn3.gif"
  Delete "$INSTDIR\help\btn2.gif"
  Delete "$INSTDIR\help\btn1.gif"
  Delete "$INSTDIR\help\bg5.jpg"
  Delete "$INSTDIR\help\bg4.jpg"
  Delete "$INSTDIR\help\bg3.jpg"
  Delete "$INSTDIR\help\bg2.jpg"
  Delete "$INSTDIR\help\bg1.jpg"
